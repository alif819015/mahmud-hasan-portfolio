  ...
  return (
    <SectionContainer>
      <div className=" text-white">
        ...
        <h5 className="md:px-12 px-1 text-center ">I have 8 months+ of experience with MERN stack. I have a good understanding of web development technologies, and stacks like MongoDB, Express.js, React.js, Bootstrap, tailwindscss, and Node.js.</h5>
